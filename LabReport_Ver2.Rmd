...
corr_Matrix <- well_being_df[c(1:2, 71:78)] #subset relevant columns
...
corPlot(neo_omega, method = "circles")
omega(neo_omega)
...
corr_Matrix2 <- well_being_df[c(1:2, 71:78)] #subset relevant columns
...
colnames(a2)   <- c("$M$", "$SD$", "1", "2", "3", "4", "5", "6", "7", "8", "9")
