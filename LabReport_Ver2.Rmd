...
SWB_ANOVA <- anova(model1, model2, model3, model4, model5)


#run model 4 again with the additional Personality group
model_personality <- lm(PW.Index ~ Age + 
               Gender +
               affect +
               Personality +
               self_wants + 
...
anova(model1, model2, model3, model4, model5, model_personality)
