...
model3_cooksd <- cooks.distance(model2)
...
outlierTest(model2) #get the most extreme outlier and return row number
...
# Run an ANOVA to check for sig effect. 
ANOVA_Models <- anova(model2, model4)
ANOVA_Models
