...
Neuroticism_omega <-  omega(well_being_df[c(11:20)])
Extraversion_omega <- omega(well_being_df[c(21:30)])
Openness_omega <-     omega(well_being_df[c(31:40)])
Agree_omega <-        omega(well_being_df[c(41:50)])
Conscient_omega <-    omega(well_being_df[c(51:60)])
```
