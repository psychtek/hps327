...
model4 <- lm(PW.Index ~ Age + 
               Gender +
               affect + MDT +
               Openess + Conscientiousness + 
               Extraversion + Agreeableness +
               Neuroticism + self_best +
               self_future + self_progress +
               self_needs + self_deserves +
               self_other + self_wants, data = well_being_df)
