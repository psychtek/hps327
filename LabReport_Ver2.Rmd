...
subset_personality_reversed <- well_being_df %>% #create an object with personality constructs and reversed scored items
...
well_being_df <- full_join(subset_personality_reversed, well_being_df) # full join of reveresed scored items andother variables. 
